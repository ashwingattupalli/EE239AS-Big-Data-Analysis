...
input_files = ['gopatriots', 'gohawks', 'nfl', 'patriots', 'sb49', 'superbowl']
test_files = ['sample1_period1', 'sample2_period2', 'sample3_period3', 'sample4_period1', 'sample5_period1', 'sample6_period2', 'sample7_period3', 'sample8_period1', 'sample9_period2', 'sample10_period3']

logger.info("EXECUTING: QUESTION 5 - TESTING DATA")
error = []
for file_name in input_files:
    ...
    for t_file in test_files:
        tweets = open('../Dataset/test_data/{0}.txt'.format(t_file), 'rb')
        first_tweet = json.loads(tweets.readline())
        start_time = first_tweet.get('firstpost_date')
